...
import { Activity, Archive, Bell, Boxes, CalendarDays, Database, LayoutDashboard, Link2, MessageCircle, PanelLeft, Tags } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Link2, label: "เชื่อม Supabase", path: "/connect" },
